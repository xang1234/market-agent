...
-- where enriched_at is null) and signals the text is LLM-derived (audited via a
-- tool_call_log), not the deterministic template. Nullable; null = not yet enriched.
