...
// react to session transitions: a null → truthy transition flushes the pending
// action, which is the mechanic that makes "sign in from the modal" and "sign
// in from the left nav while the modal is open" both resume the pending work
// (spec §3.10: inline auth interrupts preserve the pending-action payload so
// sign-in resumes the action instead of forcing a route change).
