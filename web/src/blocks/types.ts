...
// financial engine from committed results and regenerated by the snapshot
// verifier; the renderer prints them and never formats or compares numbers
// itself. Mirrors `FinancialAnswerContent` in services/financial-core.
...
export type FinancialTablePresentation = {
  kind: 'table'
  caption: string
  columns: ReadonlyArray<{ column_id: string; label_ids: ReadonlyArray<string> }>
  rows: ReadonlyArray<{ label_id: string; cells: ReadonlyArray<string | null> }>
