...
// underlying transport (EventSource etc.) — any in-flight events between the
// disconnect and reconnect are dropped, which surfaces as "skeleton stuck"
// UI with no visible failure.
